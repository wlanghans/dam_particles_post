...
!  character(*), dimension(N_Scalar), parameter :: var_lname =(/"Density","Dry air","Water vapor","Liquid water","Rain","ice","Moist Potential Temperature","Temperature","Pressure","Buoyancy"/)
  character(*), dimension(N_Scalar), parameter :: var_name =(/"rho","qv","qc","qi","t","tabs"/)
  character(*), dimension(N_Scalar), parameter :: var_unit =(/"kg/m^3","kg/kg","kg/kg","kg/kg","K","K"/)
 character(*), dimension(N_Scalar), parameter :: var_lname =(/"Density","Water vapor","Liquid water","ice","Moist Potential Temperature","Temperature"/)
